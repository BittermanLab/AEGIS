...
class ZeroshotProcessor:
    ...
    def __init__(
        ...
        self.provider_type = get_provider_type(self.model_name)
    ...
    def configure_vllm(self):
        ...
        try:
            ...
            if not vllm_endpoint:
                vllm_endpoint = os.getenv("VLLM_BASE_URL", "http://localhost:8000/v1")
    ...
    async def process_note_async(self, note_input: NoteInput) -> NotePrediction:
        ...
        try:
            ...
            if self.provider_type == "azure":
                ...
                client = OpenAI(
                    base_url=self.ollama_provider.endpoint,
            ...
            # Initialize prediction_data with a default value
