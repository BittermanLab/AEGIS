...
class OllamaModelProvider(ModelProvider):
    ...
    def get_model(self, model_name: str) -> Model:
        ...
        # Get settings for the model - log them for debugging but don't use them
        # since Ollama models don't support standard OpenAI parameters
        model_settings = get_model_settings(model_name)
        self.logger.debug("Found model settings for %s: %s (ignoring for Ollama)", model_name, model_settings)
